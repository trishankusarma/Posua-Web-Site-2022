...
import TT from "../../assets/tezpuria thespian 1.svg";
    ...
    <div className="outer_div_artist_page">
      ...
      <div className="add_details">
        <div className="inner_text">
          <div className="text_btn" onClick={() => setShow(!show)}>
            <img src={Japi} className="japi-animation" alt="" />
        ...
        <div className="details">
          <div className="detail_1">
            ...
            <div className="eng">
              ...
              in the periphery of NIT Silchar. Let's begin an 𝘖𝘬𝘶𝘢 𝘗𝘰𝘬𝘶𝘢 journey
              on 𝘛𝘢𝘹𝘪 𝘎𝘢𝘳𝘪 this spring. On the pulchritudinous evening of 26th
              March, 𝘌𝘥𝘩𝘢𝘯𝘪 𝘒𝘰𝘭𝘪𝘫𝘢 will incite euphoria among the 𝘋𝘦𝘬𝘢-𝘎𝘢𝘣𝘩𝘰𝘳𝘶𝘴.{" "}
              <br /> Let us relish the 𝘚𝘰𝘬𝘶𝘵𝘦 𝘓𝘰𝘨𝘢𝘬𝘰𝘪 scintillating staging of
              the leading female vocalist of Assam, 𝓟𝓻𝓲𝔂𝓪𝓷𝓴𝓪 𝓑𝓱𝓪𝓻𝓪𝓵𝓲 on the
              rostrum of POSUA 2022. <br /> <br /> #Posua_reviving_exuberance!{" "}
          ...
          <div className="detail_1">
            ...
            <div className="assamese">
              ...
              প্ৰতিজন অসমীয়াক প্ৰেম আৰু ৰং-ৰহইচৰে ভৰা এক অনুপম পৰিবেশৰ মাদকতাৰ
              অনুভৱ দিয়ে। বিগত দুবছৰৰ মহামাৰীৰ সংকটক এইবেলি চ'তৰ লগতে বিদাই দি
              পুনৰ এক অনুপম বসন্তৰ কামনাৰে ঋতুৰাজৰ আগমনৰ প্ৰাক্-ক্ষণত অহা ২৬
              মাৰ্চ, ২০২২ তাৰিখে ঢোল-পেপা-গগণা, বিহু, ঐনিতম আৰু হৰিনামৰ অঙ্গাংগী
              সম্বন্ধৰ ঝংকাৰত প্ৰবাহিত হোৱা আশীৰ্বাদৰ লহৰত প্ৰতিজনৰ অন্তৰত
              চিৰন্তন শান্তিৰ সঞ্চাৰৰ মানসেৰে ৰাষ্ট্ৰীয় প্ৰযুক্তিবিদ্যা
              প্ৰতিষ্ঠান, শিলচৰৰ পদূলিত পদধূলি দিবলৈ সাজু হৈছে তেজপুৰীয়া
              ডেকা-গাভৰুৰ সুৰ আৰু নৃত্যৰ সমন্বয়ৰ মাধ্যমৰে অসমীয়া লোকবাদ্য আৰু
              লোককৃষ্টিক আন্তৰাষ্ট্ৰীয় পৰ্যায়ত উপস্থাপন কৰা সাংস্কৃতিক গোষ্ঠী
              "তেজপুৰীয়া থেচ্ পিয়ান্ চ"। <br /> <br />{" "}
            ...
            <div className="eng">
              ...
              refreshing viridescence crowned by tree canopies, the flower buds
              about to bloom, the sweet chirping of birds from all around, and
              Posua blending it all, is set to welcome Spring, the King of all
              seasons, with utmost vitality. With the onset of spring, the land
              is ready to reverberate again with the symphonious rhythms of
              Dhol, Pepa, Bahi and the melodious ebullience of Bihu songs.{" "}
              <br /> Let the advent of spring and oozing of Posua stir up your
              spirits with euphoria. POSUA 2022 is thrilled to have on board the
              ‘TEZPURIYA THESPIANS’, an indigenous band with a miscellany of
              performances showcasing the best of Assamese culture and taking
              the same to International vanguards. Save the date 26th March to
              relish this musical extravaganza, and get ready to sway to the
              splendid renditions of ‘TEZPURIYA THESPIANS’. <br /> <br />{" "}
